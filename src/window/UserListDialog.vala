...
class ListUserEntry : Gtk.ListBoxRow {
  ...
  public ListUserEntry (string title, string list_name, string description) {
    ...
    var box3 = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 6);
    box3.halign = Gtk.Align.START;
    var title_label = new Gtk.Label ("<b>" + title + "</b>");
    title_label.use_markup = true;
    title_label.halign = Gtk.Align.START;
    box3.pack_start (title_label, true, false);
    var name_label = new Gtk.Label (list_name);
    name_label.halign = Gtk.Align.START;
    name_label.get_style_context ().add_class ("dim-label");
    box3.pack_start (name_label, true, true);
    var box2 = new Gtk.Box (Gtk.Orientation.VERTICAL, 3);
    box2.pack_start (box3, true, true);
