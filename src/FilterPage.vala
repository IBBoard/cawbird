...
[GtkTemplate (ui = "/uk/co/ibboard/cawbird/ui/filter-page.ui")]
class FilterPage : Gtk.ScrolledWindow, IPage, Cb.MessageReceiver {
  ...
  private void unblock_user (int64 id) {
    UserUtils.block_user.begin (account, id, false, (obj, res) => {
      try {
  ...
  public void create_radio_button (Gtk.RadioButton? group) {
    radio_button = new BadgeRadioButton(group, "cawbird-filter-symbolic", _("Filters"));
  }
