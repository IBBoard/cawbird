...
void hidden_remove_last_n_visible_asc () {
  var tm = new Cb.TweetModel ();
  tm.set_sort_order (true);
...
int main (string[] args) {
  ...
  GLib.Test.add_func ("/tweetmodel/hidden-remove-last-n-visible-asc", hidden_remove_last_n_visible_asc);
